package com.foodordering.system.payment.service.messaging.mapper;
...
import com.foodordering.system.kafka.order.avro.model.PaymentStatus;
import com.foodordering.system.domain.valueobject.PaymentOrderStatus;
...
public class PaymentMessagingDataMapper {
    ...
    public PaymentResponseAvroModel paymentCompletedEventToPaymentResponseAvroModel(
        ...
        return PaymentResponseAvroModel.newBuilder()
                ...
                .setCustomerId(paymentCompletedEvent.getPayment().getOrderId().getValue().toString())
    ...
    public PaymentResponseAvroModel paymentCancelledEventToPaymentResponseAvroModel(
        ...
        return PaymentResponseAvroModel.newBuilder()
                ...
                .setCustomerId(paymentCancelledEvent.getPayment().getOrderId().getValue().toString())
    ...
    public PaymentResponseAvroModel paymentFailedEventToPaymentResponseAvroModel(
        ...
        return PaymentResponseAvroModel.newBuilder()
                ...
                .setCustomerId(paymentFailedEvent.getPayment().getOrderId().getValue().toString())
