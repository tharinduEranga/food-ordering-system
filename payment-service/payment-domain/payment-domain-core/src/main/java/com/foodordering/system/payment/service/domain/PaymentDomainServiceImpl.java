...
import com.foodordering.system.payment.service.domain.valueobject.TransactionType;
...
import static com.foodordering.system.domain.DomainConstants.UTC;
...
public class PaymentDomainServiceImpl implements PaymentDomainService {
    ...
    public PaymentEvent validateAndInitiatePayment(Payment payment, CreditEntry creditEntry,
        ...
        if (failureMessages.isEmpty()) {
            ...
            log.info("Payment init failed for order id: {}", payment.getOrderId().getValue());
