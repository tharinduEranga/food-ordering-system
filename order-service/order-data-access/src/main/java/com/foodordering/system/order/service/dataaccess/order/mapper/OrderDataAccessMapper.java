package com.foodordering.system.order.service.dataaccess.order.mapper;

import com.foodordering.system.domain.valueobject.*;
import com.foodordering.system.order.service.dataaccess.order.entity.OrderAddressEntity;
import com.foodordering.system.order.service.dataaccess.order.entity.OrderEntity;
import com.foodordering.system.order.service.dataaccess.order.entity.OrderItemEntity;
...
import com.foodordering.system.order.service.domain.valueobject.OrderItemId;
...
import static com.foodordering.system.order.service.domain.entity.Order.FAILURE_MESSAGE_DELIMITER;
...
public class OrderDataAccessMapper {
    ...
    public OrderEntity orderToOrderEntity(Order order) {
        OrderEntity orderEntity = OrderEntity.builder()
                ...
                .failureMessages(joinAndGetOrderFailureMessages(order.getFailureMessages()))
                .build();
    ...
    private List<OrderItem> orderItemEntitiesToOrderItems(List<OrderItemEntity> items) {
        return items.stream()
                .map(orderItemEntity -> OrderItem.builder()
                        ...
                        .qty(orderItemEntity.getQuantity())
    ...
    private String joinAndGetOrderFailureMessages(List<String> failureMessages) {
