package com.foodordering.system.kafka.consumer.config;

import com.foodordering.system.kafka.config.data.KafkaConfigData;
import com.foodordering.system.kafka.config.data.KafkaConsumerConfigData;
