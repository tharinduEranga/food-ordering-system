...
-- A materialized view is a physical representation of a query that might include one or more tables with a rare condition.
-- The difference from a normal view is that with materialized view, the data is physically stored in the disc instead of running the query each time.
